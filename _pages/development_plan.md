...
* Support saving of NWB:N schemas in NWB:N HDF5 files as part of the ``/general/specifications``.
* Support use of schema cached in NWB:N files for data read
...
* **Documentation:**
    ...
    * Fix bugs and clarify the documentation
